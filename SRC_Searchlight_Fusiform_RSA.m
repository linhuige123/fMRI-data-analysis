%% Task-SRC RSA searchlight based on fusiform
...
for r = 1:nROIs
    ...
    for i = 1 : length(subdir)
        if i~=32
            ...
            cfg.results.dir = ([fileroot '/RSA/ROI_searchlight/HundrVoxelR4/' roisFILES{r} '/']) ; % where should results be stored
            ...
            cfg.files.mask = ([filebase num2str(subdir(1,i),'%.2d')...
                '/func/src/BasedRoiHundrVoFst_GLM/' roisFILES{r} '/HundrVoxelR4Mask.nii']);% mask = roi in this case, rois are resliced to participants native space.
